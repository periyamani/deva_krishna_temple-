      ...
      <g id="Login" transform="translate(519.000000, 244.000000)">
        <g id="Logo" transform="translate(148.000000, 42.000000)">
          ...
          @csrf
            ...
            <button class="btn btn-primary d-grid w-100 disabled_button">Send Reset Link</button>
          </form>
          <div class="text-center">
            <a href="#" class="d-flex align-items-center justify-content-center history_back">
